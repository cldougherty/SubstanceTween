...
public class MaterialVariableDictionaryHolder // this class is used to store parameters
{
    ...
    public Dictionary<string, object> PropertyDictionary = new Dictionary<string, object>(); // only one dictionary so i have to cast values every frame :(. I need to create dictionarys for each type now 
